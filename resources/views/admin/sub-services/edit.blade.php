                            ...
                            <form action="{{ route('admin.sub-service.update',$subService->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
									...
									<span class="btn btn-round btn-rose btn-file">
										...
										<input type="file" name="icon" value="{{ $subService->icon }}">
                                    </span>
                                                <br>
                                ...
                                <div class="form-group label-floating ">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $subService->name }}" required>
                                ...
                                <div class="form-group label-floating ">
                                    ...
                                    <textarea type="text" class="form-control" name="description" value="{{ $subService->description }}" required style="min-height: 110px">
                                    </textarea>
                                    <span class="material-input"></span>
                                </div>
